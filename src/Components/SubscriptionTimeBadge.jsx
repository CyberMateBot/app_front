...
export default function SubscriptionTimeBadge({
    ...
    return (
        <div
            className={`subscription-time-badge${expiringSoon ? ' subscription-time-badge--warn' : ''}${compact ? ' subscription-time-badge--compact' : ''}`}
            role="status"
        >
            <Clock size={compact ? 14 : 16} aria-hidden="true" />
