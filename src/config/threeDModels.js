...
export const THREE_D_MODEL_DEFINITIONS = [
    ...
    },
    {
        ...
        nameKey: 'modelHunyuan3dRapidT2dName',
        subKey: 'modelHunyuan3dRapidT2dSub',
        tab: '3d',
        categories: ['3d'],
        accent: 'teal',
        icon: Box,
    ...
    {
        id: 'hunyuan3d-v3.1-rapid-i2d',
        nameKey: 'modelHunyuan3dRapidI2dName',
        subKey: 'modelHunyuan3dRapidI2dSub',
        tab: '3d',
        categories: ['3d'],
        accent: 'teal',
        icon: Cuboid,
        badge: 'hot',
        page: 'ai-3d',
        backendModel: 'hunyuan3d-v3.1-rapid-i2d',
        group: 'Hunyuan3D',
    },
    {
        id: 'meshy6-t2d',
