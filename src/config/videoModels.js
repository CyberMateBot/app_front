...
export const VIDEO_MODEL_DEFINITIONS = [
    ...
    {
        id: 'kling-video-o3-std',
        nameKey: 'modelKlingO3StdName',
        subKey: 'modelKlingO3StdSub',
        tab: 'video',
        categories: ['video'],
        accent: 'teal',
        icon: Film,
        badge: 'new',
        page: 'ai-video',
        backendModel: 'kling-video-o3-std',
        group: 'kling',
    },
    {
        id: 'kling-video-o3-pro',
        nameKey: 'modelKlingO3ProName',
        subKey: 'modelKlingO3ProSub',
        tab: 'video',
        categories: ['video'],
        accent: 'violet',
        icon: Sparkles,
        badge: 'pro',
        page: 'ai-video',
        backendModel: 'kling-video-o3-pro',
        group: 'kling',
    },
    {
        id: 'kling-video-o3-4k',
        nameKey: 'modelKlingO34kName',
        subKey: 'modelKlingO34kSub',
        tab: 'video',
        categories: ['video'],
        accent: 'gold',
        icon: Sparkles,
        badge: 'pro',
        page: 'ai-video',
        backendModel: 'kling-video-o3-4k',
        group: 'kling',
    },
    {
        id: 'kling-v3-turbo-std',
        nameKey: 'modelKling3TurboStdName',
        subKey: 'modelKling3TurboStdSub',
        tab: 'video',
        categories: ['video'],
        accent: 'teal',
        icon: Zap,
        badge: 'new',
        page: 'ai-video',
        backendModel: 'kling-v3-turbo-std',
        group: 'kling',
    },
    {
        id: 'kling-v3-turbo-pro',
        nameKey: 'modelKling3TurboProName',
        subKey: 'modelKling3TurboProSub',
        tab: 'video',
        categories: ['video'],
        accent: 'violet',
        icon: Zap,
        badge: 'pro',
        page: 'ai-video',
        backendModel: 'kling-v3-turbo-pro',
        group: 'kling',
    },
    {
        id: 'kling-v2.6-std',
        nameKey: 'modelKling26StdName',
        subKey: 'modelKling26StdSub',
        tab: 'video',
        categories: ['video'],
        accent: 'blue',
        icon: Film,
        page: 'ai-video',
        backendModel: 'kling-v2.6-std',
        group: 'kling',
    },
    {
        id: 'kling-v2.6-pro',
        nameKey: 'modelKling26ProName',
        subKey: 'modelKling26ProSub',
        tab: 'video',
        categories: ['video'],
        accent: 'indigo',
        icon: Sparkles,
        badge: 'pro',
        page: 'ai-video',
        backendModel: 'kling-v2.6-pro',
        group: 'kling',
    },
    {
        id: 'kling-v2.1-master',
        nameKey: 'modelKling21MasterName',
        subKey: 'modelKling21MasterSub',
        tab: 'video',
        categories: ['video'],
        accent: 'amber',
        icon: Clapperboard,
        page: 'ai-video',
        backendModel: 'kling-v2.1-master',
        group: 'kling',
    },
    {
        id: 'kling-v2.0-master',
        nameKey: 'modelKling20MasterName',
        subKey: 'modelKling20MasterSub',
        tab: 'video',
        categories: ['video'],
        accent: 'amber',
        icon: Clapperboard,
        page: 'ai-video',
        backendModel: 'kling-v2.0-master',
        group: 'kling',
    },
    {
        id: 'kling-v1.6-std',
        nameKey: 'modelKling16StdName',
        subKey: 'modelKling16StdSub',
        tab: 'video',
        categories: ['video'],
        accent: 'blue',
        icon: Film,
        page: 'ai-video',
        backendModel: 'kling-v1.6-std',
        group: 'kling',
    },
    {
        id: 'kling-v1.6-pro',
        nameKey: 'modelKling16ProName',
        subKey: 'modelKling16ProSub',
        tab: 'video',
        categories: ['video'],
        accent: 'violet',
        icon: Video,
        badge: 'pro',
        page: 'ai-video',
        backendModel: 'kling-v1.6-pro',
        group: 'kling',
    },
    {
        id: 'kling-video-o1',
        nameKey: 'modelKlingVideoO1Name',
        subKey: 'modelKlingVideoO1Sub',
        tab: 'video',
        categories: ['video'],
        accent: 'sky',
        icon: Sparkles,
        page: 'ai-video',
        backendModel: 'kling-video-o1',
        group: 'kling',
    },
